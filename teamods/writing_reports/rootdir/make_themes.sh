...
if [ $# -gt 0 ]; then
    ...
    themes="agni agogo basic cbc classy cloud default epub fenics fenics_minimal flask haiku jal nature pylons pyramid redcloud scrolls slim-agogo solarized sphinxdoc traditional vlinux-theme default"
fi
