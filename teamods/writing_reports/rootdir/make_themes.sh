...
if [ $# -gt 0 ]; then
    ...
    themes="ADCtheme agni agogo basic bootstrap cbc classy cloud default epub fenics fenics_minimal flask haiku impressjs jal nature pylons pyramid redcloud scrolls slim-agogo  sphinxdoc traditional vlinux-theme default"
fi
