...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("Experiments with Schemes for Exponential Decay");
        $("div.related:last  ul li:not(.right):first a").text("Experiments with Schemes for Exponential Decay");
    }
});