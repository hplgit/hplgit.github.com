...
The :math:`\theta`-rule is used to solve :eq:`ode` numerically:
...
``solver`` (found in the `decay_mod <https://github.com/hplgit/INF5620/tree/gh-pages/src/decay/experiments/decay_mod.py>`_ module):
